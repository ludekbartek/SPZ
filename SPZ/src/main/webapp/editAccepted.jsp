        ...
        <c:when test="${empty change }">
            ...
            <c:otherwise>
                <form action="${pageContext.request.contextPath}/SPZServlet/editspz" method="post">
                    ...
                    <input type="hidden" name="projectid" value="${project.id}"/>
                    <div class="formItem">
                        <span class="label"><label for="desc" class="textarealabel"><f:message key="note"/></label></span>
                        <span class="input">
                            <textarea class="textareainput" name="desc" <%--cols="80"--%> rows="8" maxlength="8000"></textarea>
                        </span>
                    </div>
                    <div class="formItem">
